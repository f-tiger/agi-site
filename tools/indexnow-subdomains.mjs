...
const HOSTS = ['play.agiscorecard.com', 'source.agiscorecard.com', 'goldrush.agiscorecard.com', '35.agiscorecard.com', 'learn.agiscorecard.com', 'fanzha.agiscorecard.com'];
