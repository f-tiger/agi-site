...
H. **新站群（learn + fanzha）**（owner /goal 2026-09-15「持续做新站点，新站点方向你做好调研再做，包括工具做好，seo，geo等都做好」；两站均复用 D1 after35-events 6109b81e-…，表分别 `lev`/`lua_audit` 与 `fev`/`fua_audit`，永不共用表）：**只报数不动**——各自的真人 page_view（28d/7d）、`tool_result`、`resource_click`；两站都无用户内容，无需审核。①学什么 learn.agiscorecard.com（sites/learn，成年人失业后学什么 / 家庭教育）②识骗 fanzha.agiscorecard.com（sites/fanzha，AI 换脸拟声时代的反诈判定 + 转账前 60 秒 / 家庭暗号卡 / 12 问筛查；**暗号永不上传、永不进链接、永不进 D1**；创业类骗局归三十五后 /screen，两站不互相复制）。冷启动期报 0 就是正确动作，不要为了有东西可写而加页。优化只在有真人信号或一手依据变更（教育部指南改版、技能照亮前程行动到期、家庭教育法修订、反诈法修订、公安机关新提示）时做一件；候选队列在各自 docs/research-2026-09-15.md §五，未过三门不上。判定线 learn 10-15 / 12-15、fanzha 10-15 / 12-15，均见各自 CLAUDE.md。新站上线后当轮必须完成舰队接线（heartbeat、ai_access_probe、ai_referrals、check_bot_ua、indexnow hosts、automation map、本 prompt 的 H 块），否则新站不算上线。
