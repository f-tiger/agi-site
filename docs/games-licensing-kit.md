# 游戏授权直售弹药包（2026-08-22，owner「最激烈的探索赚钱方式」执行件）

依据:三路激进变现调研(细节在 `aggressive-monetization-2026-08.md`)。H5 授权是
唯一有第一人称成交记录的 30 天首单路径:独立开发者 $500/款×4 款卖给新门户
...
非独占、按域名站锁;买方可重命名、改视觉、加广告;不得转售/再授权/上架源码
市场;IP 归我方;交付 = 静态文件 zip(clean 构建)+ 部署说明;款到交付
(PayPal/wire/USDT 均可);无退款,购前可完整试玩。

## 渠道与顺序(owner 动作已最小化)

1. **Coolmath Games**(第 1 周,最优先):developers.coolmathgames.com 提交。
   明文「买断非独占授权、开发者保留 IP、可继续分发别处」;逻辑谜题正中其
   「thinking games」口味;**他们会反问你要价——按报价卡报 $400-800/款**。
   提交版可以先用现网 URL,过审后再交 clean zip。
2. **HTML5GameDevs Marketplace 论坛**(同周):唯一还活着的 FGL 替代品
   (FGL 市场 2016 已死,2025 重生为消费者门户,不是市场)。挂双款+报价卡。
3. **CodeCanyon**(第 1-2 周):2026-07-01 起 Envato 全员 50% 抽成、无独占
   惩罚——可同时直售。定价 $19-29/regular(该市场是 $10-40 走量渠道,
   与直售分层不冲突:CodeCanyon 卖的是部署权 regular license,白标另谈)。
4. **itch.io 免费橱窗**(随手):Coolmath 员工被证实主动在 itch 上找授权对象。
5. **直销外联**(第 2-4 周,owner 邮件):10 个二线门户 + 5-10 家小型媒体
   (含台/港/东南亚中文媒体——大陆版号墙外的中文买家没人服务)。
6. **不做**:微信小游戏授权(版号墙:2025 全年进口版号仅 95 个)、MarketJS
   (只卖自有 IP,是竞对不是渠道)。
