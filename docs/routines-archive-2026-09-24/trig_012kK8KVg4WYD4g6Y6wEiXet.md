...
H. **新站群（中文 learn / fanzha / firstjob + 英文 codeword / powerbill）**（owner /goal 2026-09-15「持续做新站点，新站点方向你做好调研再做，包括工具做好，seo，geo等都做好」，及 2026-09-15「扩展几个适配欧洲、美国的站点」；五站均复用 D1 after35-events 6109b81e-…，表前缀依次 `lev`/`fev`/`jev`/`cev`/`pev`（各自带 `*ua_audit`），永不共用表）：**只报数不动**——各站真人 page_view（28d/7d）、`tool_result`/`calc_run`/`card_print`、`resource_click`；五站都无用户内容，无需审核。中文：①学什么（成年人学什么/家庭教育）②识骗（AI 换脸拟声反诈；**暗号永不上传、永不进链接、永不进 D1**）③第一份工作（应届生；**斯坦福 Canaries 每次更新都要核数字与日期**，且必须保留「未发现全经济范围大规模替代」那一句）。英文/美欧：④Code Word codeword.agiscorecard.com（克隆语音与深伪诈骗；法源 FCC 24-17 2024-02-08、FTC 冒充规则 2024-04-01、AI Act 第 50 条 2026-08-02 与 Reg (EU) 2026/1744；**`/code-word` 页禁止任何网络调用**，闸门强制；**2026-12-02 欧盟机器可读标记生效当天必须复核三页日期表**，AI Act 真源是主站 `eu-ai-act-what-applies-now`，本站只引用不另立台账）⑤The Power Bill powerbill.agiscorecard.com（AI 数据中心是否抬高电费；**EPRI 反向证据不许删**，闸门断言；**永不发布人均归因金额**；PJM 新一轮容量拍卖结果公布时必须同轮更新首屏 $329.17 与翻转条件）。分流：中年失业→三十五后、该学什么→学什么、中文诈骗→识骗、英文诈骗→Code Word、加盟入伙→三十五后 /screen、德语家庭节能→getecoback、AI 资本开支→主站 /ai-capex-trillion-dollar；各站互链不互相复制内容。冷启动期报 0 就是正确动作，不要为了有东西可写而加页。优化只在有真人信号或一手依据变更（教育部指南、技能照亮前程、家庭教育法、反诈法、公安机关提示、劳动合同法、应届生认定政策、斯坦福研究、FCC/FTC 新规、AI Act 日期、IC3 年报、PJM 拍卖、EIA STEO、EPRI、Eurostat）时做一件；候选队列在各自 docs/research-2026-09-15.md §五，未过三门不上。判定线：learn 10-15 / 12-15、fanzha 10-15 / 12-15、firstjob 10-31 / 12-15、codeword 11-15 / 12-31、powerbill 11-15 / 12-31，均见各自 CLAUDE.md。新站上线后当轮必须完成舰队接线（heartbeat、ai_access_probe、ai_referrals、check_bot_ua、indexnow hosts、automation map、本 prompt 的 H 块），否则新站不算上线。建站节奏纪律见 docs/new-site-pipeline.md §四点五——**新方向先问「能否用已上线站点的一个新页面替代」**；本轮已按此否掉两个方向（英文 AI 入门岗判定、EU AI Act 独立站），因为主站 `amodei-white-collar-bloodbath-prediction` 与 `eu-ai-act-what-applies-now` 已覆盖且更新更勤。
