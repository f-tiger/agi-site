...
| `agi-trader.yml` | `40 19 * * 1-5` + `40 20 * * 1-5` | **新增 2026-09-05**:owner 自用镜像交易器(Alpaca,缺省纸面);job 级门 `vars.TRADER_ENABLED=='1'`,未设 = 0 分钟;≈44 分钟/月;日志只打印计数;详见 `tools/trader/README.md` |
