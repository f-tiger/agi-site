# Portable Air Conditioner Running Cost 2026: €0.35/Hour
...
**In short:** portable ACs draw 800–1,400 W · at €0.35/kWh that's €0.28–0.49 per hour · a typical 1,000 W unit ≈ €0.35/hour and ≈ €2.80 per 8-hour night at full draw · realistic heatwave month with thermostat cycling: €25–45 · the #1 hidden cost is an unsealed exhaust hose · formula: kWh = W ÷ 1,000 × hours, cost = kWh × price.
...
- **Get the BTU size right.** A unit matched to your room cools quickly, then cycles down. Use our [BTU size guide](https://getecoback.com/en/guide/how-many-btu-do-i-need.html) — roughly 340 BTU per m² is the anchor.

- **Seal the window — the #1 hidden cost.** An exhaust hose hanging out of an open window lets hot outside air pour straight back in, and the unit can run twice as long for the same result. A window seal kit costs €15–25 and usually pays for itself within a couple of weeks. Tilt-and-turn windows need a specific approach — see our [tilt-and-turn window guide](https://getecoback.com/en/guide/portable-ac-tilt-and-turn-windows.html).
