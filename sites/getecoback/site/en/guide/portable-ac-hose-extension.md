# Extend Portable AC Exhaust Hose: The 2 m Rule (2026)
...
**In short:** Extending works, but keep the total run to ~2 m · same diameter as the original (130 or 150 mm) · straight and smooth, no S-curves · insulate the hose — it radiates 50–60°C heat back into the room · never narrow the diameter · some manufacturers like De'Longhi warn extensions can void the warranty · often smarter: move the unit closer or use a window seal kit.
...
- **Seal the window instead.** Often the hose reaches, but the window can't close around it. A window seal kit (fabric with a zip, ~€15–25) fixes that for tilt-and-turn windows without any extra hose — see our [guide to portable ACs in tilt-and-turn windows](https://getecoback.com/en/guide/portable-ac-tilt-and-turn-windows.html), or the [skylight and roof window version](https://getecoback.com/en/guide/portable-ac-skylight-roof-window.html) if your only opening is in the roof.
...
[Portable AC in tilt-and-turn windows →](https://getecoback.com/en/guide/portable-ac-tilt-and-turn-windows.html)
[Portable AC exhaust through a skylight or roof window →](https://getecoback.com/en/guide/portable-ac-skylight-roof-window.html)
