# Portable AC Leaking Water? 6 Causes & Quick Fixes (2026)
...
**In short:** cooling always produces condensate — modern units evaporate most of it out through the exhaust hose · a tank that fills faster in humid spells (even daily) is normal · a puddle under a running unit is not: check drain plug, tank, level and filter/coil, in that order · the full-tank shut-off (float switch) is a feature, not a fault · for round-the-clock use, fit a continuous drain hose with a downward slope · still leaking after all checks? That's a service case.
...
- **3. Check the unit is level.** A monobloc parked half on a rug edge lets condensate slosh past the pan and the sensor. Lay a spirit level on top in both directions — it must sit flat. This also matters for the window seal; see our guide to [venting a portable AC through tilt-and-turn windows](https://getecoback.com/en/guide/portable-ac-tilt-and-turn-windows.html).
...
**The two most useful buys against the drip:**
...
[How to clean a portable air conditioner (filter, tank, mould) →](https://getecoback.com/en/guide/how-to-clean-portable-air-conditioner.html)
[Dehumidifier to dry clothes: what it really costs →](https://getecoback.com/en/guide/dehumidifier-drying-clothes-cost.html)
[Best portable air conditioner for a European heatwave →](https://getecoback.com/en/guide/best-portable-air-conditioner-europe-heatwave.html)
