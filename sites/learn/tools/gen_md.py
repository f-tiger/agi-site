...
PAGES = ["adult-what-to-learn", "kids-coding", "family-education-law", "free"]
...
def convert(slug):
    ...
    lines = ["# " + title, "", "> " + desc, "", "来源: https://learn.agiscorecard.com/" + slug + ("  · 更新 " + updated.group(1) if updated else ""), ""]
...
def main():
    parts = ["# 学什么 — 全文(判定页与免费资源,机器可读)", "", "> AI 时代该学什么:成年人失业后与家庭教育。本文件由页面自动生成;页面是唯一真源。站点说明见 https://learn.agiscorecard.com/llms.txt", ""]
    for slug in PAGES:
