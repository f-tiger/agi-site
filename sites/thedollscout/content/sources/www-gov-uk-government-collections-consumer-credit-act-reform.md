...
- **URL:** https://www.gov.uk/government/collections/consumer-credit-act-reform
- **HTTP status:** 404
- **Retrieved:** 2026-07-31
- **Characters:** 3020
- **Why queued:** Checks the claim that s.75 thresholds are unchanged and connected-lender reform was deferred. If wrong, the finding is time-expired rather than false. [run 1: the phase-2 publication URL 404d; switched to the collection page]
