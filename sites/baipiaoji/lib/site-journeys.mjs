...
export const SITE_JOURNEYS = [
  ...
  entry('members','/members','connect','membership','会员与云保存','Membership & cloud saving','了解账户、云项目保存与会员权益；以页面当前条件为准。','Review accounts, cloud project saving and membership benefits under the terms shown on the page.',['work-plan','video-studio'],{optionalRegistration:{zh:'账户与云功能需要注册；说明页公开。',en:'Account and cloud features require registration; the information page is public.'}}),
