...
export const events=['page_view','sample_run','own_run','report_export','tool_open','mcp_setup','citation_copy','cost_check','watch_save','watch_compare','review_save','review_export'];
