...
## 三点五、决策参照系(2026-08-23 增设,来源 docs/paradigm-bet-framework-2026-08.md)

孙宇晨 A 栏框架(站位+注意力资产+凭证收割)与本站「引用份额优先」战略互证。
资源分配显式原则:①押增长斜率最陡的线(当前证据:agi 引用页周翻倍、游戏
门户分成线),不均摊 ②「圈内头名」纪律——做每个生态位里可验证的第一
(唯一可审计 AGI 指数/唯一验证解谜题库),不做便宜替代品 ③凭证收割主动化
(MCP 注册表/官方目录/门户上架=本站的 Forbes 榜)。冲突时以一手数据为准。
