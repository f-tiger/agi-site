...
PAGES = ['ai-voice-clone-detection', 'are-ai-robocalls-illegal', 'already-paid-what-now', 'resources']
...
def convert(slug):
    ...
    lines = ["# " + title, "", "> " + desc, "", "Source: https://codeword.agiscorecard.com/" + slug + ("  · updated " + updated.group(1) if updated else ""), ""]
...
def main():
    parts = ["# Code Word — full text (judgements and official entry points, machine readable)", "", "> Verify before you pay: AI voice-clone and deepfake scam judgements, with US and EU rules. Generated from the pages themselves. Pages are the single source of truth. Site notes:  https://codeword.agiscorecard.com/llms.txt", ""]
    for slug in PAGES:
