...
PAGES = ["ai-face-voice-scam", "anti-fraud-law", "what-is-96110", "resources"]
...
def convert(slug):
    ...
    lines = ["# " + title, "", "> " + desc, "", "来源: https://fanzha.agiscorecard.com/" + slug + ("  · 更新 " + updated.group(1) if updated else ""), ""]
...
def main():
    parts = ["# 识骗 — 全文(判定页与官方入口,机器可读)", "", "> AI 时代的反诈判定与工具。本文件由页面自动生成;页面是唯一真源。站点说明见 https://fanzha.agiscorecard.com/llms.txt", ""]
    for slug in PAGES:
