...
const ALLOWED = new Set(["play_start", "solve", "share_copy", "hint_used", "play_again", "sub_click", "challenge_copy", "challenge_open", "challenge_result", "hub_click", "sweep_share", "sub_submit", "sub_ok", "sub_fail"]);
