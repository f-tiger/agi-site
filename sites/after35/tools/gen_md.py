...
PAGES = ["after-35-restart", "laid-off-programmer-ai", "easier-or-harder-after-35", "checklist"]
...
def convert(slug):
    ...
    lines = ["# " + title, "", "> " + desc, "", "来源: https://35.agiscorecard.com/" + slug + ("  · 更新 " + updated.group(1) if updated else ""), ""]
...
def main():
    parts = ["# 三十五后 — 全文(判定页与官方清单,机器可读)", "", "> 失业中年人的建议、撮合与二次启动。本文件由页面自动生成;页面是唯一真源。站点说明见 https://35.agiscorecard.com/llms.txt", ""]
    for slug in PAGES:
