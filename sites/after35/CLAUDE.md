...
## v7(2026-09-15,owner:「进行一次吸引力强大的升级,让中年人找到合理的创业,或者找工作工具,聚焦他们的痛点」)
痛点来自 research §二(知乎原题)与常识:①没收入 ②不知道能做什么 ③被拉加盟/入伙/买课 ④想找内推开不了口。
首页首屏改为**痛点导航四格**(每格一个工具)。新工具两件:
- `/screen` **创业与副业机会筛选器**:12 个是非题,权重 3 的四条(入门费/拉人头/团队计酬/保本)单条即
  「远离」;红旗逐条对照《禁止传销条例》第七条、《商业特许经营管理条例》第七(两店一年)/八(备案)/
  十二(单方解除期)/二十一(30 日书面披露)条,给司法部法规库与 gov.cn 原文链接;第二步盈亏平衡
  (每月需客户数、回本月数)用用户自己的数字;判定写进 URL `?a=`,分享给家人。**本站只给条款与算术,
  不给法律意见**,页面明写。
- `/referral` **内推信生成器**(找工作工具,35+ 的真实渠道是熟人):称呼/关系/一句话/目的/城市/卡链接
  → 三条微信(开口/详细/五天后跟进),按关系与目的换措辞,刻意不写「我失业了」;附 10 人名单表。
  与经验卡闭环:卡链接进微信,微信带人回 /c/<id>。
两者均纯前端、不上传;事件 `path_result{screen:*, screen_calc:*, referral:*}`、`share_click{screen, referral_m*}`。
判定线补登:10-14 另看 screen 判定次数 ≥ 30 且 referral 生成 ≥ 20(痛点工具有没有人用)。
