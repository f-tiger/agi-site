...
- **同日第三轮(owner:「再深度调研看看」)→ `docs/us-equity-10x-deepdive-2026-09.md`,
  三处纠正,排序被自己的尺子推翻**:①**Arteris 降级**——公司自己的 2030 目标只有 $2.5 亿收入,
  按 15x 市销率也只值 3.4 倍;且 2023/2024 两年只增长 7%,「44%」是新近加速不是记录;
  增长计划还含「两笔收购」。**我上一轮用「公司自己的目标」杀掉 Everspin,却没用在 Arteris 上,
  这是方法论错误。** ②**Eos 移出名单**——Cerberus 拿 penny warrants + 可转优先股,完全稀释后
  **33%,最高 49%**,企业价值涨 10 倍普通股东只拿 5–6 倍。③**SkyWater 是过期信息**——
  已被 IonQ 以 $35/股约 $18 亿收购,2026-07-31 完成。
  **新第一名 Centrus(LEU)**:美国唯一 HALEU 生产商,现产 **900 公斤/年**,$9 亿 DOE 非稀释
  订单目标 **6 MTU/年**,而 **DOE 说 2035 年美国需求可能 50 吨/年(今天的 55 倍)**;
  TerraPower 已因缺 HALEU 从 2028 推到 2030+。$19 亿现金(递延收入仅 $8,500 万,但主体是
  2025-08 的 $8.05 亿 0% 可转债,转股价 $229.62 不在钱内),backlog $45 亿到 2040。
  **唯一「公司自己的计划就隐含 10 倍」的是 ASP Isotopes(ASPI,$5.38 亿市值,自称 2031 年
  EBITDA > $3 亿)**,但仍是开发阶段、HALEU 停在 MOU,按彩票买。
  **三条新方法论**:先查公司自己的长期目标、先查资本结构、先查现金是赚来还是融来的。
  **环境警告**:不盈利的 Russell 2000 公司自 2025 年中 +154%,盈利的只有 +34%——买彩票最贵
  的时候就是所有人都在买彩票的时候。
- **同日第四轮(owner:「扩大调研范围，对美股对标闪迪的标的大范围调研」)→
  `docs/us-equity-sandisk-peers-2026-09.md`**:15+ 标的的存储/内存全链条。
  **核心发现:涨幅几乎完全由「是否拥有晶圆」决定**——拥有的(SNDK +550~780%、MU +256~297%)
  涨几倍,不拥有的(SIMO +54%、NetApp +45%、Everpure +42%)只涨四五成。这不是错配是经济学:
  这一轮涨的是**价格**不是出货量(服务器 DRAM 单季 +90~95%),租金全归晶圆所有者,
  下游是付钱那方(Dell 目录价 +17%、HPE +10~15%)。**美股同层对标只有 Micron 一个**
  (Kioxia 东京上市、三星/SK 韩国上市)。**下一棒是设备**:Kioxia+闪迪 2026-08-27 宣布
  日本投超 **$310 亿**(合资延到 2034,但取决于日本政府支持),Lam 的 NAND 占系统收入
  从 12% 跳到 23%、$400 亿 NAND 转换投资大部分在 2027 年底前发生——代价是 Lam 已
  $4,020 亿市值、61 倍 PE、年内 +139%。**闪迪 8 倍前瞻 PE 不是便宜,是市场预告分母会缩水**
  (上季 NAND 涨约 70%,TrendForce 看本季只有 10~15%);但它手上有 $939 亿合约收入
  (含 $165 亿 AI 保证)+ $155 亿回购授权,与 2018 年的纯现货敞口不同。
  **⚠️ 会买错标的的坑:Pure Storage 已更名 Everpure,新代码本轮未核到确定值。**
- **同日第五轮 = 收敛(owner:「股票10倍到底选择哪些标的」)→
  `docs/us-equity-10x-decision-card-2026-09.md` 决策卡。后续会话要引用名单,引用这一份。**
  **能给 10 倍的只有两个:①Centrus(LEU,$168.31/$33.6 亿)——2–4 倍大概率、10 倍小概率;
  ②ASP Isotopes(ASPI,$4.27/$5.38 亿)——大概率腰斩或归零、小概率 10 倍+。**
  卫星仓分配:LEU 45% / Arteris 20%(3–4 倍压舱石不是 10 倍)/ SIMO 15%(存储链唯一结构性
  选项,赌 2027 出货量)/ ASPI 10%(按全损配)/ 现金 10%(判定线触发才动);
  **LEU+ASPI 是同一个 HALEU 论点,合计不超过卫星仓 55%**;核心仓永远 80–90% 宽基。
  **只买一个 = LEU**(下行有 $19 亿现金 + $45 亿 backlog + $9 亿非稀释政府资金托底;
  稀缺性已被 TerraPower 推迟两年证实;已跌 63% 不需赌估值扩张)。
  **明确不买**:AXTI、Bloom、闪迪/Micron、Eos、Aehr、Lam(逻辑最硬但 61 倍 PE 是买确定性
  不是买 10 倍)、HDD 两家、企业存储。**先验命中率 10–15%,大概率两个都到不了 10 倍**——
  这句要跟着名单一起说,不许只说名单。
- **09-11 第六轮(owner 第六次问「看看美股哪些可以10倍」)→ `docs/us-equity-10x-sweep2-2026-09.md`,
  横向扫了七个没碰过的板块,决策卡升 v2。**新发现一个结构:矿企转 AI 数据中心房东,合同收入是
  市值的 2–4 倍**(13 家合同 >$700 亿,利润率 80–90%,对手方 Google/AWS/Anthropic/AMD/微软)。
  **名单新增第三个 10 倍候选 Core Scientific(CORZ,$57.7 亿)**:AMD 15 年 530 MW ≈ $140 亿已签,
  **AMD 有权 2028 年前追加 1.9 GW 至 2.5 GW**——唯一「已签 + 同一对手方巨大追加权」结构,
  与 Centrus 同构;10 倍 = AMD 全额行权。资本结构:$43 亿债(7.75% 票据 $33 亿)+ 首期 $60 亿
  项目债,设计上不稀释;2022 破产过、2025-10 股东否决 CoreWeave $90 亿收购、今天低于当时收购价。
  **卫星仓 v2:LEU 40 / CORZ 20 / AIP 15 / ASPI 10 / SIMO 10 / 现金 5。只买一个仍是 LEU**
  (它的追加权在 DOE 手里,CORZ 的在 AMD 一家手里)。
  **被否的**:无人机(Ondas 12 个月融 $12 亿+ 且 $15 亿认股权悬置;Red Cat 毛利率 16.1% + 两份
  做空报告质疑合同规模)、铀矿(瓶颈在浓缩不在矿,俄罗斯 2025 仍占美国浓缩 26%、2028-01-01 全禁
  ——强化的是 Centrus)、小堆开发商(Oklo 从 $174 跌到 $43,三家全无收入,买燃料不买反应堆)、
  机器人、半导体设备小盘(UCTT +328% 涨完了)、**生物科技用篮子不选单票**(FDA 2026-02 改单一
  关键试验是真红利,但单票尽调超出会话能力,我不装)。Centrus 09-09 与 Radiant 签供铀合同,
  论点无反向新闻。新判定线:**2028-12-31 AMD 是否行使追加权**。
